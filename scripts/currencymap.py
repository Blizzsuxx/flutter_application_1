...
currencyToFlagAndSymbol = {}
for currency in currencies:
    currencyToFlagAndSymbol[currency["code"]] = {
        "flag": currency["flag"].split("/").pop(),
...
with open("currencyToFlagAndSymbol.json", "w") as f:
    json.dump(currencyToFlagAndSymbol, f, indent=4)
